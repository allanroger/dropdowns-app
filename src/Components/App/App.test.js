...
describe('Dropdown component', () => {
  it('Fetch Brazilian states', async () => {
    const fetchMock = jest
      .spyOn(global, 'fetch')
      .mockImplementation(() => Promise.resolve({ json: () => mockInfo }));
